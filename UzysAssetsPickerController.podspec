Pod::Spec.new do |s|
  ...
  s.platform     = :ios , '8.0'
  s.source       = { :git => "https://github.com/uzysjung/UzysAssetsPickerController.git", :tag => "0.9.9" }
  s.requires_arc = true
  s.source_files = "UzysAssetsPickerController/Library"
  s.resources = ["UzysAssetsPickerController/Library/**/*.{xib}","UzysAssetsPickerController/Library/**/*.{png}"]
